...
# 1698
def get_max_length_word_in_txt(valid_path):
    max_length = 0
    for root, dirs, files in os.walk(valid_path):
        for f in files:
            numLines = 0
...
def get_length_word_list(valid_path):
...
if __name__ == "__main__":
    ...
    max_length = get_max_length_word_in_txt("Data")
